...
boxplot(mtcars1$mpg, ylab='Miles/(US) gallon', xlab="Transmission type automatic", col='lightblue',main='mtcars - boxplot of MPG',width = 240,height = 240)
...
boxplot(mtcars1$mpg, ylab='Miles/(US) gallon', xlab="Transmission type manual", col='lightblue',main='mtcars - boxplot of MPG',width = 240,height = 240)
